...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 30, 2025 at 10:34 AM
...
INSERT INTO `case_status` (`status_id`, `case_id`, `acceptance_status`, `center_id`, `case_took_up_time`, `reached_location`, `spot_animal`, `rescued_animal`, `rescue_photo`, `closed_time`, `status`) VALUES
(4, 42, 'Accepted', 3, '2025-12-29 10:32:18', 'Yes', 'Yes', 'Yes', 'uploads/rescue_photos/1767024984_cat.jpg', '2025-12-29 21:46:24', 'Closed'),
(5, 43, 'Accepted', 3, '2025-12-29 11:51:52', NULL, NULL, NULL, NULL, NULL, 'Inprogress'),
(6, 44, 'Accepted', 3, '2025-12-29 12:06:59', NULL, NULL, NULL, NULL, NULL, 'Inprogress'),
(7, 45, 'Accepted', 6, '2025-12-29 13:48:14', NULL, NULL, NULL, NULL, NULL, 'Inprogress'),
(8, 46, 'Accepted', 3, '2025-12-29 21:23:59', NULL, NULL, NULL, NULL, NULL, 'Inprogress'),
(9, 47, 'Accepted', 3, '2025-12-29 21:27:25', NULL, NULL, NULL, NULL, NULL, 'Inprogress');
...
INSERT INTO `centers` (`center_id`, `center_name`, `address`, `latitude`, `longitude`, `phone`, `email`, `created_at`, `is_active`, `total_cases_handled`, `avg_response_time`, `center_status`) VALUES
(1, 'Blue Cross of India', 'Velachery, Chennai', 12.9838800, 80.2187400, '9876543210', 'contact@bluecross.org', '2025-11-30 11:46:25', 'Yes', 12, 66, 'Operating'),
(2, 'Paws Rescue Center', 'Adyar, Chennai', 13.0067000, 80.2570000, '9876543211', 'support@paws.org', '2025-11-30 11:46:25', 'Yes', 5, 16, 'Operating'),
(3, 'Animal Welfare Trust', 'Tambaram, Chennai', 12.9245000, 80.1278000, '9876543212', 'help@awt.org', '2025-11-30 11:46:25', 'Yes', 32, 502, 'Operating'),
(4, 'Hope Animal Shelter', 'Anna Nagar, Chennai', 13.0878000, 80.2092000, '9876543213', 'team@hopeanimals.org', '2025-11-30 11:46:25', 'Yes', 19, NULL, 'Operating'),
(5, 'Stray Care Foundation', 'T Nagar, Chennai', 13.0362000, 80.2344000, '9876543214', 'info@straycast.org', '2025-11-30 11:46:25', 'Yes', 20, 66, 'Operating'),
(6, 'Blue Cross', 'Vellore', 13.0067000, 80.2187400, '9087564322', 'bluecross@gmail.com', '2025-11-30 12:02:39', 'Yes', 36, 30, 'Operating'),
(7, 'Green Valley Association', 'Guindy', 13.0067000, 80.2187400, '9567896023', 'greenvalley@gmail.com', '2025-11-30 12:05:31', 'Yes', 6, 713, 'Operating'),
(8, 'Little Light', 'Nungambakkam', 13.0569000, 80.2425000, '9890123456', 'lightup@gmail.com', '2025-12-11 04:03:44', 'Yes', 0, NULL, 'Operating'),
(9, 'Stray Shelter', 'Coimbatore', 11.0174000, 76.9589000, '9412345678', 'shelter@gmail.com', '2025-12-11 04:09:21', 'Yes', 0, NULL, 'Operating'),
(10, 'Blue Wave', 'Coimbatore', 11.0174000, 76.9589000, '9412345678', 'shelter@gmail.com', '2025-12-29 08:11:44', 'Yes', 0, NULL, 'Operating'),
(11, 'Animal Shelter', 'Coimbatore', 11.0174000, 76.9589000, '9494126578', 'animal@gmail.com', '2025-12-29 08:13:03', 'Yes', 0, NULL, 'Operating');
...
(3, 3, 42, '1767025486_cat.jpg', 4500.00, '2025-12-29 21:54:46', 'Approved', NULL, NULL, NULL, NULL, NULL);
...
INSERT INTO `users` (`id`, `name`, `phone`, `email`, `password`, `user_type`, `created_at`) VALUES
(1, 'Vennela', '9494126599', 'sri412@gmail.com', '1234567', 'admin', '2025-11-27 05:02:04'),
(2, 'Surya', '9494126789', 'surya123@gmail.com', '1234', 'user', '2025-11-29 07:43:25'),
(3, 'Ravi', '9494126767', 'ravi134@gmail.com', '9878', 'user', '2025-12-05 04:23:47'),
(4, 'Rahul', '9494126751', 'rahul234@gmail.com', '4567', 'user', '2025-12-05 04:27:23'),
(5, 'Green Valey', '9494126599', 'jin143@gmail.com', '1234', 'organization', '2025-12-10 08:20:28'),
(6, 'Peace Shelter', '9494125833', 'peace234@gmail.com', '7891', 'organization', '2025-12-17 08:51:27'),
(7, 'Sravya', '8967452367', 'srav678@gmail.com', '6930', 'user', '2025-12-17 17:11:05'),
(8, 'Lahari', '9381260162', 'laharipriya1212@gmail.com', '121205', 'user', '2025-12-23 14:24:31'),
(9, 'Janani', '8765431289', 'janani123@gmail.com', '1596', 'user', '2025-12-25 12:50:39'),
(10, 'Save Animals', '9656412358', 'save234@gmail.com', '7890', 'organization', '2025-12-25 12:52:03'),
(11, 'Namjoon', '8121292979', 'nam123@gmail.com', '123658', 'user', '2025-12-25 17:23:47'),
(12, 'Animal Welfare Center', '8452369852', 'center345@gmail.com', '5689', 'organization', '2025-12-25 17:24:52'),
(13, 'Sreya', '9494126762', 'sreya456@gmail.com', '678z9', 'user', '2025-12-26 04:32:02');
...
--
ALTER TABLE `cases`
  MODIFY `case_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=48;

--
-- AUTO_INCREMENT for table `case_escalations`
--
ALTER TABLE `case_escalations`
  MODIFY `escalation_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=194;
